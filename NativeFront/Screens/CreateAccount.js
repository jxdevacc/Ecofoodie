...
//         }
//         else {
//         fetch('http://10.21.183.52/register/', {
//             method: "POST",
//             headers: {
//                 'Content-Type': 'application/json',
//             },
//             body: JSON.stringify({password:password, email: email, username: username})})
//             .then(res => res.text())    
//             .then(data => {
//                 console.log(data)
...
//     }
    ...
    //     </Text>
    //     </Pressable>
    //     <Pressable style = {styles.altbtn} onPress = {() => props.navigation.navigate("SignIn")}>
    //     <Text style = {styles.alttxt}>
    //         Already have an account?
    //         <Text style = {{color: 'blue'}}> Sign In.</Text>
    //     </Text>
